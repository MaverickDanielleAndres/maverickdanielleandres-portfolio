...
import { X, ChevronLeft, ChevronRight, Calendar, Code, User, Github, ExternalLink, Maximize2 } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-hidden flex flex-col min-h-0">
          ...
          <div className="hidden md:flex justify-between items-center p-3 sm:p-4 border-b border-neutral-700/50 flex-shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg transition-all duration-300 hover:scale-105 group border border-neutral-600 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
        ...
        <div className="md:hidden flex justify-center items-center p-3 border-t border-neutral-700 gap-4 flex-shrink-0">
          <button
            onClick={() => setCurrentSection((prev) => (prev > 0 ? prev - 1 : 1))}
            className="flex items-center gap-2 px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg transition-all duration-300 hover:scale-105 group border border-neutral-600 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            disabled={currentSection === 0}
          >
            <ChevronLeft className="w-4 h-4" />
            <span>Prev</span>
...
const ProjectModalWithStyles = (props: ProjectModalProps) => {
