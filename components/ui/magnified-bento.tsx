...
const TAG_ROWS = [
  [
    { id: "communication", icon: Message01Icon, label: "Communication" },
    { id: "teamwork", icon: UserGroupIcon, label: "Teamwork" },
    { id: "problem-solving", icon: Idea01Icon, label: "Problem-Solving" },
    { id: "adaptability", icon: RotateLeftIcon, label: "Adaptability" },
    { id: "time-management", icon: WorkHistoryIcon, label: "Time Management" },
    { id: "leadership", icon: Target01Icon, label: "Leadership" },
  ],
  [
    { id: "reliable", icon: AiSecurity01Icon, label: "Reliable" },
    { id: "initiative", icon: FlashIcon, label: "Initiative" },
    { id: "critical-thinking", icon: Brain01Icon, label: "Critical Thinking" },
    { id: "collaboration", icon: UserAccountIcon, label: "Collaboration" },
    { id: "emotional-intelligence", icon: Search01Icon, label: "Emotional Intelligence" },
    { id: "conflict-resolution", icon: Settings02Icon, label: "Conflict Resolution" },
  ],
  [
    { id: "active-listening", icon: CustomerService01Icon, label: "Active Listening" },
    { id: "public-speaking", icon: Presentation01Icon, label: "Public Speaking" },
    { id: "strategic-planning", icon: HierarchyIcon, label: "Strategic Planning" },
    { id: "mentorship", icon: UserIcon, label: "Mentorship" },
    { id: "work-ethic", icon: Task01Icon, label: "Work Ethic" },
    { id: "empathy", icon: AiChat02Icon, label: "Empathy" },
    { id: "integrity", icon: LockIcon, label: "Integrity" },
  ],
];
...
const CONFIG = {
  ...
  description:
    "Beyond technical skills, I bring a collaborative mindset, strategic thinking, and a commitment to delivering high-quality results through effective communication.",
  containerHeight: "h-[180px] sm:h-[220px]",
  lensSize: 120,
};
...
const MagnifiedBento = () => {
  ...
  const clipPath = useMotionTemplate`circle(45px at calc(50% + ${lensX}px - 10px) calc(50% + ${lensY}px - 10px))`;
  const inverseMask = useMotionTemplate`radial-gradient(circle 45px at calc(50% + ${lensX}px - 10px) calc(50% + ${lensY}px - 10px), transparent 100%, black 100%)`;
  ...
  return (
    <div className="flex items-center justify-center p-4 sm:p-6 w-full not-prose">
      <div className="group relative w-full max-w-[420px] overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border bg-card p-1.5 sm:p-2 shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1">
        ...
        <div className="p-4 sm:p-5 px-4 pb-6 sm:pb-8 pt-2 sm:pt-3">
