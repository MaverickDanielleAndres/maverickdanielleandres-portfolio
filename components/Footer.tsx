...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/maverick-danielle-andres-641564373',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/maverickdanielle.andres/',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-neutral-800/50 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0 text-center">
            <div className="text-xs text-neutral-500">
              ©2026 Maverick Danielle P. Andres. All rights reserved.
            </div>
